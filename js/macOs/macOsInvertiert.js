(function () {
    ...
    var cssGrundfarbe = 'head{background-color:'+newBackgroundColor+';color:'+newColor+';}a {color:'+newLinkColor+';} a:visited {color:'+newLInkColorVisited+';}';
    frame(document);

    function frame(d) {
        var style = d.createElement('style');
        style.className = 'wcagstyle';
        styleContent = d.createTextNode(cssGrundfarbe);
